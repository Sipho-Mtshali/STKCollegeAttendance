...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize dashboard functions if user is authenticated
    if (currentUser && userRole) {
        if (window.location.pathname.includes('teacher.html') && userRole === 'teacher') {
            if (typeof initTeacherDashboard === 'function') {
                initTeacherDashboard();
            }
        } else if (window.location.pathname.includes('student.html') && userRole === 'student') {
